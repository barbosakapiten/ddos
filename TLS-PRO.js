...
console.log(color('red', 'blue')("Emotional relief and shield piercing script TG：MrPstar7"));
console.log("\x1b[36mTarget\x1b[37m  %s | " + "\x1b[35m" + parsed.host + "\x1b[37m", process.argv[2]);
console.log("The target submission was successful, and the pressure measurement time is %s Second", process.argv[4]);
